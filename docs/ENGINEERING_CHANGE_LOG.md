...
deliberately NOT in that list — see CHG-2026-09-05-017 and -013.
...
not extremes. See CHG-2026-09-05-013.

### CHG-2026-09-05-018 — Record that `PRICE_FLOOR`'s rationale is now in doubt
...
### CHG-2026-09-05-017 — Set the event-association window from measurement, 20 s -> 90 s
...
### CHG-2026-09-05-016 — Stamp a poll sequence on every clock and score observation
...
### CHG-2026-09-05-015 — Stop reading a period boundary as a goal
...
### CHG-2026-09-05-014 — Persist the settlement result of every watched market
...
### CHG-2026-09-05-013 — Spend the path budget on time, not on arrival order
...
### CHG-2026-09-05-012 — Add `PAPER_MAX_BOOK_AGE_MS`, default 0 (record only)
...
### CHG-2026-09-05-011 — Record the numbers behind every exit label, and the book at the exit fill
...
### CHG-2026-09-05-010 — Record the age of the book every paper fill used
...
### CHG-2026-09-05-009 — Key every row of one episode with `episode_id`
...
### CHG-2026-09-05-008 — Return and persist the evidence behind every confirmation decision
...
### CHG-2026-09-05-007 — Record the book, the fill it refused, and the load behind every signal
...
* `confirmation`: see CHG-2026-09-05-008.
